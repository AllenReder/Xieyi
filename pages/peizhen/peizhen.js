...
Page({
  ...
  click0: function () {
    wx.navigateTo({
      url: '/pages/peizhen/detail?index=' + 0, // 新页面的路径
    })
  },
  click1: function () {
    wx.navigateTo({
      url: '/pages/peizhen/detail?index=' + 1, // 新页面的路径
    })
  },
  click2: function () {
    wx.navigateTo({
      url: '/pages/peizhen/detail?index=' + 2, // 新页面的路径
    })
  },
  click3: function () {
    wx.navigateTo({
      url: '/pages/peizhen/detail?index=' + 3, // 新页面的路径
    })
  },
  click4: function () {
    wx.navigateTo({
      url: '/pages/peizhen/detail?index=' + 4, // 新页面的路径
    })
  },
